...
interface OrderJpaRepository : JpaRepository<OrderEntity, UUID> {
    fun findByIdAndOrganizationId(id: UUID, organizationId: UUID): OrderEntity?
    fun findAllByOrganizationId(organizationId: UUID): List<OrderEntity>
    fun findAllByIdInAndOrganizationId(ids: List<UUID>, organizationId: UUID): List<OrderEntity>
